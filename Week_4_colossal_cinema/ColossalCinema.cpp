...
int main ()
{
    ...
    else if ( age < 10)                         // if the user is greater than or 2 years old AND less than 10 years old
    {
        ticketPreTax = childRate;                                 // calculates Ticket Price $12.00
    }

    else if ( age < 60 )                      //if the user is greater than or 10 years old AND less than sixty years old
    {
